...
*/  \___|_| |_|\__,_|_| |_|\___|_|\__,_|_.__/ \___/ \__| __||__ hacer algo importante que lo cambie todo :)     //
*//////////////////////////////////////////////////////  \    / //////////////////////////////////////////////////
*/                                                        \  /                                                  ///                                                         \/                                                   //
...
.then(link =>{
  ...
  .setColor('GOLD')
  .setFooter("Chancla Bot, versión 1.0, creado por ! Chanclex#1111 y TrollfesT#2552");
    message.channel.send(embed);
...
if(command === 'comandos') {
  ...
  .addField("<a:admin:778803282457264128>♦️Comandos de admins", "`kick`, `ban`, `usuario`")
  .setFooter("Chancla Bot, versión 1.0, creado por ! Chanclex#1111 y TrollfesT#2552")
  .setColor(0x66b3ff)
